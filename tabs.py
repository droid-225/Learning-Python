from tkinter import *
from tkinter import ttk # gives access to widgets not found in base tkinter module
...
# fill : fills space on x-axis, y-axis, or both, here it keeps the tabs at the top left corner
